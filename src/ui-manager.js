                ...
                <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div id="results-container" class="hidden space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <!-- New: Potential Fraud Loss Prevented Card -->
                            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                                <div class="flex items-center">
                                    <div class="p-2 bg-green-100 dark:bg-green-900 rounded-lg">
                                        <svg class="w-6 h-6 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 1.12-3 2.5S10.343 13 12 13s3-1.12 3-2.5S13.657 8 12 8zM4 6v6a8 8 0 008 8v0" />
                                        </svg>
                                    </div>
                                    <div class="ml-4">
                                        <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Potential Fraud Loss Prevented</p>
                                        <p id="fraud-loss-prevented" class="text-2xl font-bold text-gray-900 dark:text-white">$0.00</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Fraud Rate Trend</h3>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                            ...
                            <!-- New: Top 5 High-Risk Transactions -->
                            <div class="mt-6">
                                <h4 class="text-md font-semibold text-gray-900 dark:text-white mb-2">Top 5 High-Risk Transactions</h4>
                                <div id="top5-container" class="overflow-x-auto"></div>
                            </div>

                            <!-- New: Download Predictions Button -->
                            <div class="mt-6 text-right">
                                <button id="download-predictions-btn" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg">
